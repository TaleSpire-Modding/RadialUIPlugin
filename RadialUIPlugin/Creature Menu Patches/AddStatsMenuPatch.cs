...
namespace RadialUI.Creature_Menu_Patches
{
    ...
    internal sealed class AddStatsMenuPatch
    {
        ...
        internal static bool Prefix(ref MapMenu mapMenu, CreatureBoardAsset ____selectedCreature,
            CreatureMenuBoardTool __instance)
        {
            ...
            if (menuStats != null &&
                RadialUIPlugin._removeOnCharacter.CanAdd("Stats", miniId.ToString(), targetId.ToString()))
