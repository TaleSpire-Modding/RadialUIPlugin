...
namespace RadialUI.Creature_Menu_Patches
{
    ...
    internal sealed class CreatureRootMenuPatch
    {
        ...
        internal static bool Prefix(CreatureBoardAsset ____selectedCreature, CreatureMenuBoardTool __instance, float ____hitHeightDif)
        {
            ...
            map = MapMenuManager.OpenMenu(____selectedCreature.transform.position + Vector3.up * ____hitHeightDif, true);
